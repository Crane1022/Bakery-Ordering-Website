...
async function register({ email, password, dob, gender, address, city, postcode, state: regionState }) {
  state.error = ''

  try {
    const data = await apiFetch('/auth/register', {
      method: 'POST',
      body: JSON.stringify({ email, password, dob, gender, address, city, postcode, state: regionState })
    })
